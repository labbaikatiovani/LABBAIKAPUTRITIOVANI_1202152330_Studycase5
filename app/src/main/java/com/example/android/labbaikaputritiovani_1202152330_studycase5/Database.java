...
public class Database extends SQLiteOpenHelper {
    ...
    public Database(Context context) {
        ...
        dbase.execSQL("create table if not exists "+nama_tabel+" (todo varchar(35) primary key, description varchar(50), priority varchar(3))");
    }
    ...
    public boolean inputdata(AddData list) {
        ...
        long hasil = dbase.insert(nama_tabel, null, val);
        if (hasil==-1) {
            return false;
        }else {
            return true;
    ...
    public boolean removedata(String ToDo) {
        return dbase.delete(nama_tabel, kolom_1+"=\""+ToDo+"\"", null)>0;
    }
