...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shapeclr.setText(getShapeColor(color));
    }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(SettingActivity.this, ToDoListActivity.class);
        //memulai intent
    ...
    public void choosecolor(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //set warna shape sesuai yang dipilih
                shapeclr.setText(getShapeColor(color));
                //put shared preference
                spe.putInt("Colourground", color);
                //commit shared preference
                spe.commit();
            }
        });

        //ketika menekan Cancel pada dialog
